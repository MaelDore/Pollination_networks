...
##### Script 3: Generate final graphs for the paper #####
...
# Inputs:
  ...
  # Summary table with information on mulitple graph execution from Script 2 (all_multiple_plots_summary_all_VE)

# Outputs:

  # Figure 2: Effects of anthropogenic pressures on pollination network species richness (A) and connectance (B)
  # Figure 3: Effects of climate on pollination network species richness (A) and connectance (B)
  # Figure 4: Effects of sampling characteristics on pollination network species richness (A & C) and connectance (B & D)

  # Graphical Abstract: Effect of anthropogenic pressures (A & B), mean annual temperature (C & D) and sampling effort (E & F) on species richness (A, C & E) and connectance (B, D & F)
...
##### Figure 2: Effects of anthropogenic pressures on pollination network connectance (A) and species richness (B) #####

# A/ Effect of human influence on species richness
# B/ Effect of human influence on network connectance
...
layout.show(decoupe) # Show visually the layout
...
# Chose panel A: effect of Human Influence on Species richness
panel_A <- which((all_multiple_plots_summary_all_VE$VAE == "S") & (all_multiple_plots_summary_all_VE$VE_short_name == "HF"))

# Chose panel B: effect of Human Influence on Connectance
panel_B <- which((all_multiple_plots_summary_all_VE$VAE == "C") & (all_multiple_plots_summary_all_VE$VE_short_name == "HF"))
...
##### Figure 3: Effects of climate on pollination network connectance (A) and species richness (B) #####

# A/ Effect of mean temperature on species richness
# B/ Effect of mean temperature on network connectance
...
# Chose panel A: Effect of mean temperature on Species richness 
panel_A <- which((all_multiple_plots_summary_all_VE$VAE == "S") & (all_multiple_plots_summary_all_VE$VE_short_name == "Tmean"))

# Chose panel B: Effect of mean temperature on Connectance
panel_B <- which((all_multiple_plots_summary_all_VE$VAE == "C") & (all_multiple_plots_summary_all_VE$VE_short_name == "Tmean"))
...
##### Figure 4: Effects of sampling characteristics on pollination network connectance (A & C) and species richness (B & D) #####

# A/ Effect of sampling time on species richness
# B/ Effect of sampling effort on network connectance
# C/ Effect of taxonomic resolution on species richness
# D/ Effect of annual time span of sampling on network connectance
...
# Chose panel A: Effect of sampling time on species richness
panel_A <- which((all_multiple_plots_summary_all_VE$VAE == "S") & (all_multiple_plots_summary_all_VE$VE_short_name == "Time"))

# Chose panel B: Effect of sampling effort on network connectance
panel_B <- which((all_multiple_plots_summary_all_VE$VAE == "C") & (all_multiple_plots_summary_all_VE$VE_short_name == "SE"))

# Chose panel C: Effect of taxonomic resolution on species richness
panel_C <- which((all_multiple_plots_summary_all_VE$VAE == "S") & (all_multiple_plots_summary_all_VE$VE_short_name == "Taxo"))

# Chose panel D: Effect of annual time span of sampling on network connectance
panel_D <- which((all_multiple_plots_summary_all_VE$VAE == "C") & (all_multiple_plots_summary_all_VE$VE_short_name == "ATS"))
...
# C/ Effect of mean temperature on species richness
# D/ Effect of mean temperature on network connectance
...
# Chose panel C: Effect of mean temperature on Species richness 
panel_C <- which((all_multiple_plots_summary_all_VE$VAE == "S") & (all_multiple_plots_summary_all_VE$VE_short_name == "Tmean"))

# Chose panel D: Effect of mean temperature on Connectance
panel_D <- which((all_multiple_plots_summary_all_VE$VAE == "C") & (all_multiple_plots_summary_all_VE$VE_short_name == "Tmean"))

# Chose panel A: Effect of sampling time on species richness
panel_E <- which((all_multiple_plots_summary_all_VE$VAE == "S") & (all_multiple_plots_summary_all_VE$VE_short_name == "Time"))

# Chose panel B: Effect of sampling effort on network connectance
panel_F <- which((all_multiple_plots_summary_all_VE$VAE == "C") & (all_multiple_plots_summary_all_VE$VE_short_name == "SE"))


# Save plot index corresponding to each panel
index_plot_to_plot <- c(panel_A, panel_B, panel_C, panel_D, panel_E, panel_F)

# Define panel letters
panel_letters <- c("A", "B", "C", "D", "E", "F")


# Open plot
pdf(file = paste0("./Final_figures/Graphical_Abstract.pdf"), width = 14, height = 18)

# Cut panels
layout(mat = matrix(data = c(1,0,2,3,0,4,5,0,6), nrow = 3, ncol = 3, byrow = TRUE), # Numbers = order of plots ;
       widths=c(7, 0.2, 7),     # Widths of columns
       heights=c(6, 6, 6),       # Heights of lines
       respect=TRUE)
